...
Der Import aus CAD enthielt diese invalide Geometrie. Bei einem solch komplexen Modell eine Fehlersuche einzuleiten ist daher sehr zeitaufwendig werden und das Ergebnis der Autoreduktion ist Qualitativ minderwertig wie die folgende Abbildung aus einem anderen Projekt zeigt \sieheAbb{2.4}. 
